...
import { getCart } from '../services/backend-service';
...
const Checkout = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    showNotification('Shipping details saved. Choose a payment method.', 'success');
    navigate('/payment', { state: { shippingAddress: orderData, pricing } });
  };
