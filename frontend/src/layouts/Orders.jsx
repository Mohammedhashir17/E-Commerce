          ...
          <Paper key={order._id} sx={{ p: { xs: 2, sm: 3 }, mb: { xs: 2, sm: 3 } }}>
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'start', mb: 2 }}>
              ...
              <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap', justifyContent: { xs: 'flex-start', sm: 'flex-end' } }}>
                ...
                <Chip
                  variant="outlined"
                  label={getPaymentMethodLabel(order)}
                  sx={{
                    borderColor: order.paymentMethod?.toLowerCase() === 'cod' ? '#FACC15' : 'var(--border-subtle)',
                    color: order.paymentMethod?.toLowerCase() === 'cod' ? '#FACC15' : 'var(--text-primary)',
                  }}
                />
              </Box>
            </Box>
